...
void pubLatestOdometry(const Eigen::Vector3d &P, const Eigen::Quaterniond &Q, const Eigen::Vector3d &V, double t)
{
    ...
    Eigen::Quaterniond q_transform(0.0, 1.0, 0.0, 0.0);
    Eigen::Quaterniond q_result(q_transform.matrix() * Q.matrix());
    odometry.pose.pose.orientation.x = q_result.x();
    odometry.pose.pose.orientation.y = q_result.y();
    odometry.pose.pose.orientation.z = q_result.z();
    odometry.pose.pose.orientation.w = q_result.w();
